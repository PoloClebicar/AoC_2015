...
def turn_on(array, startPosition, endPosition):
    ...
    while rowStart <= rowEnd:
        while collumStartCLone <= collumEnd:
            array[rowStart][collumStartCLone] = array[rowStart][collumStartCLone] + 1
...
def toggle(array, startPosition, endPosition):
    ...
    while rowStart <= rowEnd:
        while collumStartCLone <= collumEnd:
                array[rowStart][collumStartCLone] = array[rowStart][collumStartCLone] + 2
